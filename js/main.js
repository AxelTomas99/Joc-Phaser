...
PlayState._createHud = function () {
    ...
    this.lifeIcon1 = this.game.make.image(20,50,'icon:heart');
    this.lifeIcon2 = this.game.make.image(40,50,'icon:heart');
    this.lifeIcon3 = this.game.make.image(60,50,'icon:heart');
    ...
    if (vides === 3){
        this.hud.add(this.lifeIcon1);
        this.hud.add(this.lifeIcon2);
        this.hud.add(this.lifeIcon3);
    }else if (vides === 2){
        this.hud.add(this.lifeIcon1);
        this.hud.add(this.lifeIcon2);
    }else {
